...
/**
 * Derive an AES-GCM 256-bit CryptoKey from a 6-digit PIN and salt using PBKDF2 (50,000 iterations).
 * Caches derived keys to prevent UI latency on subsequent packet transfers.
 */
