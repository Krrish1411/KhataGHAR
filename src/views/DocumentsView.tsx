...
export const DocumentsView: React.FC = () => {
  ...
  const [selectedEntityFilter, setSelectedEntityFilter] = useState<LinkedEntityType | 'all' | 'unlinked'>('all');
  ...
  return (
    <div className="h-full flex flex-col min-h-0 overflow-hidden w-full max-w-[1750px] mx-auto px-1 sm:px-2 space-y-2.5 anim-fade select-none">
      {/* ─────────────────────────────────────────────────────────────
      ...
      <div className="flex items-center justify-between gap-3 pt-0.5 shrink-0">
        <div>
          <div className="flex items-center gap-2">
            <span className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-brand-50 dark:bg-brand-950/50 border border-brand-200/60 dark:border-brand-800/60 grid place-items-center text-brand-600">
              <FolderLock className="w-4 h-4" />
            </span>
            <h1 className="font-display font-extrabold text-[18px] sm:text-[22px] tracking-tight text-ink">
          ...
          <p className="text-[11px] text-ink/50 mt-0.5 hidden sm:block">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 sm:py-2 rounded-2xl border border-line bg-surface hover:bg-moss text-ink text-xs font-bold flex items-center gap-1.5 transition-all shadow-xs cursor-pointer"
          ...
          <button
            ...
            className="px-3.5 py-1.5 sm:py-2 rounded-2xl bg-brand-500 hover:bg-brand-600 text-white text-xs font-bold flex items-center gap-1.5 shadow-sm transition-all active:scale-[0.98] cursor-pointer"
          >
